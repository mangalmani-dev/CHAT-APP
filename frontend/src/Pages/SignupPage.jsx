...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* Left side - Form */}
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 bg-white dark:bg-gray-900 transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className="input input-bordered w-full pl-10 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
      ...
      <div className="hidden lg:flex justify-center items-center bg-gradient-to-br from-primary/10 to-primary/20 dark:from-primary/30 dark:to-primary/50">
        <AuthImagePattern
